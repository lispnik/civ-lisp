...
(defparameter *units*
  (%table
   '((:warriors    :attack 1 :defense 1 :move 1 :cost 10 :requires nil :domain :land)
     ...
     (:frigate     :attack 2 :defense 2 :move 3 :cost 40 :requires :magnetism :domain :sea :capacity 4 :carries :land)
     (:knights     :attack 4 :defense 2 :move 2 :cost 40 :requires :chivalry :domain :land)
     (:sail        :attack 1 :defense 1 :move 3 :cost 40 :requires :navigation :domain :sea :capacity 3 :carries :land)
     (:settlers    :attack 0 :defense 1 :move 1 :cost 40 :requires nil :domain :land :abilities (:found-city :terraform))
     (:trireme     :attack 1 :defense 0 :move 3 :cost 40 :requires :map-making :domain :sea :capacity 2 :carries :land)
